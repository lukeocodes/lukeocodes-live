<template>
  <button>
    <svg width="1em" height="1em" viewBox="0 0 24 24" class="darkmode">
      <g>
        <path
    ...
    <svg width="1em" height="1em" viewBox="0 0 24 24" class="lightmode">
      <g>
        <path
...
<style scoped>
:not(.dark) svg.darkmode {
  @apply hidden;
}
.dark svg.darkmode {
  @apply inline;
}
:not(.dark) svg.lightmode {
  @apply inline;
}
.dark svg.lightmode {
  @apply hidden;
